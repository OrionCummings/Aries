...
CONSTANT_OPCODE_MAP = {
    ...
    "st":   (2, InstructionFormat.Register, True),
    "ld":   (2, InstructionFormat.Register, True),
...
# Single byte bold hex format string
HEX_FORMAT = "{:02X}"
...
DEFAULT_INSTRUCTION_MEMORY_BASE_ADDRESS     = 0
...
DEFAULT_VIDEO_MEMORY_SIZE_IN_BYTES          = 64
