...
void register_file_print(const register_file_t reg_file, bool verbose) {
    ...
    if (verbose) {
        ...
        printf("z = %01d c = %01d p = %01d s = %01d o = %01d t = %01d h = %01d\n", reg_file.zero, reg_file.carry, reg_file.parity, reg_file.sign, reg_file.overflow, reg_file.trap, reg_file.hpc);
    } else {
