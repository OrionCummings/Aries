...
void test_bint_not(void) {
    ...
    uint8_t b1_expected_bytes[] = { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFE };
    uint8_t b2_expected_bytes[] = { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xEA, 0x76, 0xD2, 0x2A, 0x5A, 0xFD };
    uint8_t b3_expected_bytes[] = { 0xD4, 0x5E, 0x7A, 0x32, 0x03, 0x35, 0x2F, 0xAB, 0xEE, 0x2A, 0x39, 0x79, 0x5C };
    ...
    // Create and populate test bints
    bint_t* b1 = bint_new(b1_expected->n_bytes);
    bint_t* b2 = bint_new(b2_expected->n_bytes);
    bint_t* b3 = bint_new(b3_expected->n_bytes);
    uint8_t b1_bytes[] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01 };
    uint8_t b2_bytes[] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x15, 0x89, 0x2D, 0xD5, 0xA5, 0x02 };
    uint8_t b3_bytes[] = { 0x2B, 0xA1, 0x85, 0xCD, 0xFC, 0xCA, 0xD0, 0x54, 0x11, 0xD5, 0xC6, 0x86, 0xA3 };
