#include "test_bint_add.h"

void run_bint_add_tests(void) {
    RUN_TEST(test_bint_add);
    RUN_TEST(test_bint_add_increment_no_overflow);
    RUN_TEST(test_bint_add_decrement_no_underflow);
    RUN_TEST(test_bint_add_increment_overflow);
    RUN_TEST(test_bint_add_decrement_underflow);
    RUN_TEST(test_bint_add_overflow_first_byte);
    RUN_TEST(test_bint_add_overflow_mid_byte);
    RUN_TEST(test_bint_add_overflow_last_byte);
    RUN_TEST(test_bint_add_underflow_first_byte);
    RUN_TEST(test_bint_add_underflow_mid_byte);
    RUN_TEST(test_bint_add_underflow_last_byte);
}
