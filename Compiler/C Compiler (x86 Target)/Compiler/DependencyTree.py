...
class DependencyTree:
    ...
    def __init__(self, source_path: Path, include_path: Path = None) -> None:
        ...
        # Create the root node from the entry point file
...
if __name__ == "__main__":
    ...
    source_path = Path("C:\\Users\\Orion\\Stash\\PersonalProjects\\Aries\\Compiler\\C Compiler (x86 Target)\\Source Files\\Example\\")
